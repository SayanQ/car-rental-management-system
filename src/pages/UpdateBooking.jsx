            ...
            <MDBCol>
                ...
                <MDBRow className='g-0'>
                    ...
                    <MDBCardBody className='text-black d-flex flex-column justify-content-center align-items-center'>
                        <h3 className="mb-5 text-uppercase fw-bold">Car No. : {car_No}</h3>
                        ...
                        <MDBCol md='6'>
                            <MDBInput wrapperClass='mb-4' className='colour' placeholder={carInput.colour} label='Colour' size='lg' id='colour' type='text' onChange={(e) => handleInputChange(e)}/>
                        </MDBCol>
